...
async function aceitar(form, id) {
    ...
    form.remove()
    try {
        const resposta = await fetch('http://localhost:3000/aceitar', {
            method: "POST",
...
async function recusar(form, id) {
    ...
    try {
        const resposta = await fetch('http://localhost:3000/recusar', {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
async function carregarMovimentos() {
    const resposta = await fetch('http://localhost:3000/movimento');
...
async function carregarFora() {
    const resposta = await fetch('http://localhost:3000/listaFora');
    const movimentos = await resposta.json();
