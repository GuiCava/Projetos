...
export function CartTNR() {
    return (
        <a className="cart load-hidden grid grid-rows-[auto_auto] lg:grid-rows-[auto_1fr] cursor-pointer hover:scale-[1.02]  max-w-[clamp(300px,27vw,36rem)] transition-transform ease-in-out duration-400" href="https://guicava.github.io/Projetos/TNR" target="_blank">
