...
export function CartNiver() {
    return (
        <a className="grid grid-rows-[auto_1fr] lg:grid-rows-[auto_1fr] cursor-pointer hover:scale-[1.02] duration-600 ease-in-out max-w-[clamp(300px,27vw,36rem)]" href="https://guicava.github.io/Projetos/CartãoAniversário" target="_blank">
