...
export function Sobre() {
    useEffect(() => {
        ScrollReveal().reveal('#containerSobre', {
            duration: 2000,
            delay: 1800
        });
    }, []);
    return(
        <section className="grid grid-rows-[auto_auto] grid-cols-[auto_1fr] rounded-[4px] bg-[#333] h-auto px-[clamp(0.3rem,0.1vw,2rem)] pb-[clamp(0.3rem,0.1vw,2rem)] items-center justify-self-center w-max max-w-[clamp(22rem,47vw,80rem)] load-hidden" id="containerSobre">
